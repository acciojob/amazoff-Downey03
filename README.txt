...
GET /orders/get-order-count-by-partner-id/{partnerId}
...
GET /orders/get-orders-by-partner-id/{partnerId}
 Pass partnerId as path variable
...
Get count of orders which are not assigned to any partner:
 GET /orders/get-count-of-unassigned-orders
 No params or body required
Return Integer wrapped in a ResponseEntity object
...
GET /orders/get-last-delivery-time/{partnerId}
Pass partnerId string as path variable
 ...
 OrderController.java
  OrderService.java
   OrderRepository.java
    Order.java
     DeliveryPartner.java Class

Note:

Use ResponseEntity object to return the required objects
in the controllers
Make sure you follow the requirements for the controller
very very carefully
 or your application will give compilation error while
